---
title: "How to read a suit’s quality in 30 seconds"
description: "Judge a suit in 30 seconds: pinch for canvas, read the seams and buttonholes, scrunch the cloth. Sam's bench guide to spotting real quality fast."
tldr: "Pinch the cloth below the lowest buttonhole for a floating third layer of canvas, read the seams and buttonholes up close, then scrunch the fabric for spring-back. Those four tells separate a suit built to last from one that is glued together."
...
1. **A pattern drafted to your body**, not a factory size adjusted after the fact.
2. **Full or half floating canvas**, never fused glue that bubbles and dies.
3. **Cloth matched to how you live** — weight, weave and season, not just a Super number.
4. **Hand-finished details** — buttonholes, working cuffs, a lining you actually chose.
5. **A tailor who keeps your pattern** and re-fits it as your body changes.

A [custom-tailored suit](/suits) with all five outlasts and out-fits anything off a rack. The quick tests below are how you spot each one in ten seconds.
...
A fused jacket can look fine on the rack. It just won't age with you, and it can't be let out or reshaped the way a canvassed one can. That's the difference between a suit you replace and one we adjust for fifteen years. More on that trade-off in [custom vs. rental](/guides/custom-vs-rental-wedding-suit) and [the custom tuxedo](/guides/the-custom-tuxedo).
...
This is where a real tailor earns their keep. A machine spits out a seam; a bench-made suit is built to be opened up and rebuilt. See [suits for hard-to-fit bodies](/guides/suits-for-hard-to-fit-bodies) for why that inlay matters.
...
Numbers like Super 120s or 150s describe how fine the yarn is, not how good the suit is — very high numbers are delicate and wrinkle easily, so don't let a label do your thinking. Trust the scrunch. You can feel the difference across our [cloth library](/fabrics), and the [navy suit](/guides/the-navy-suit) and [how to care for your suit](/guides/how-to-care-for-your-suit) guides go deeper on choosing and keeping good cloth.
...
Come by and put your hands on the difference yourself — pinch the canvas, scrunch the cloth, look at a real hand buttonhole. No pressure, no sales pitch, just 30 years at the bench happy to show you what to look for. [Book a free first fitting](/book) or [design your own suit](/design) when you're ready.
