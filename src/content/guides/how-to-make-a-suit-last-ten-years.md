---
title: "How to make a suit last ten years"
description: "Make a suit last ten years with four simple habits: rotate it, brush it, hang it right, and steam instead of dry cleaning. A Vaughan tailor's plain-spoken guide."
tldr: "A suit dies from neglect between wears, not from being worn. Rotate it so it never goes two days running, brush it after every wear, hang it on a wide shaped hanger, and steam instead of dry cleaning — and a well-made suit stays sharp ten to fifteen years."
...
related: ["how-often-to-dry-clean-a-suit", "how-to-pack-and-travel-with-a-suit", "when-to-alter-vs-replace", "how-to-care-for-your-suit"]
---
...
The garment itself is rarely the problem. Good wool wants to last — it's springy, breathable, and forgiving. What wears a suit out early is friction, moisture that never dries, and the chemical beating of the dry-cleaning machine. Take those three off the table and the fabric will outlast the trends. If you want to understand what makes a garment worth keeping this long in the first place, that comes down to construction — how we build it is laid out on our [process page](/process).
...
It also starts with how the thing is built. A properly canvassed, well-cut suit rewards care; a glued-together one won't last no matter what you do. If you're thinking about a garment made to go the distance, come [design your suit](/design) with us, explore the [cloth](/fabrics), or just book a [free first fitting](/book) — no pressure, no hard sell. We're in Vaughan, on the Thornhill line, and we've been doing this a long time.

**Keep reading:** [How to care for your suit](/guides/how-to-care-for-your-suit) · [Custom vs. rental for a wedding suit](/guides/custom-vs-rental-wedding-suit) · [The navy suit](/guides/the-navy-suit)
