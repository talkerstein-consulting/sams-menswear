---
title: "Suits for hard-to-fit builds: when off-the-rack won't"
description: "Athletic, tall, short, broad, or slim — why standard sizing fails certain builds and how a made-to-measure suit finally fits."
tldr: "If suits never fit, it isn't you — it's the sizing. Off-the-rack assumes an average build most men don't have, so athletic, tall, short, broad, or uneven-shouldered bodies get failed. Made-to-measure sets each measurement to your number, so nothing gets sacrificed."
pillar: "Fit"
pillarHref: "/design"
eyebrow: "Fit"
updated: 2026-07-04
order: 31
faqCats: ["Fit", "Bespoke, made-to-measure & off-the-rack"]
related: ["how-a-suit-should-fit", "bespoke-vs-made-to-measure-vs-off-the-rack", "your-first-fitting"]
---
...
Made to your measurements, the ratio problem disappears — chest, waist, shoulder and length are each set to *your* number, not a size chart's compromise. Uneven shoulders get built into the pattern instead of fought against. Nothing has to be sacrificed to make something else work. [Bespoke vs made-to-measure vs off-the-rack →](/guides/bespoke-vs-made-to-measure-vs-off-the-rack)

## What to expect at the fitting

Twenty-six measurements, questions about posture and how you carry yourself, and an honest conversation about what will and won't flatter your build. That's the whole point — the suit adapts to you. [What your first fitting is like →](/guides/your-first-fitting)

Never had a suit that fit? [Book a fitting](/book) — this is exactly what custom is for.
