---
title: "What doctors should wear: trust, practicality, and life under the coat"
description: "A Toronto tailor's honest guide to what doctors should wear — under the white coat, in clinic, at conferences — for trust, hygiene, and long days."
tldr: "Dress conservative, clean, and comfortable in cloth that survives a long day, and put your money into fit rather than flash. In clinic that means a well-fitted navy or charcoal suit or jacket-and-trouser; in the OR or ED it is scrubs. The trick is knowing which room you are in."
pillar: "Dressing for your profession"
pillarHref: "/business"
eyebrow: "Business"
updated: 2026-07-05
order: 96
faqCats: ["Fit", "Cost & value"]
related: ["dressing-for-senior-management", "dressing-for-law", "the-navy-suit", "how-a-suit-should-fit"]
---
...
The coat covers your torso, which means your shirt collar and cuffs do most of the talking. A collar that gapes or a cuff that swallows your hand undoes an expensive coat. This is where [proper fit](/guides/how-a-suit-should-fit) earns its keep — a shirt cut to your neck and arm length sits clean under the coat and doesn't bunch.
...
You want cloth that signals steady and serious. A [navy suit](/guides/the-navy-suit) is the single most useful thing in a doctor's closet — it works for clinic, a hospital board meeting, a conference talk, and a colleague's retirement dinner. Charcoal is its equal partner. Both sit under a white coat without clashing.
...
A surgeon can live in scrubs 90% of the week and still get caught flat-footed at a conference podium in a jacket that fits like it was borrowed. The suit isn't for the patients — it's for the peers, the deans, the funding committees, and the lawyers. When you're presenting or advocating, you want to look like the authority in the room, and that's a job for [tailored business clothing](/business). One good suit and one good blazer covers nearly all of it.

If you're early-career and interviewing for a residency or a staff position, that's a separate calculation — read my take on [the interview suit](/guides/the-interview-suit). Selection committees are conservative, and fit matters more than label.
...
- **The unaltered suit.** Shoulders too wide, sleeves swallowing the cuffs, trousers pooling on the shoe. It costs almost nothing to fix and changes everything. Fit is the whole game — see [how a suit should fit](/guides/how-a-suit-should-fit).
...
For the surgeon who wants one thing done properly, or the specialist building a small working wardrobe, I'd rather [build a suit around your actual body and schedule](/design) than sell you five things you won't wear.
...
If you're a physician, surgeon, or specialist and you want clothes that hold up to your actual working day — I'll come to you, measure properly, and tell you honestly what you need and what you don't. [Book a free, no-obligation fitting](/book) or [design a suit](/design) built around the life you actually live under that coat.
