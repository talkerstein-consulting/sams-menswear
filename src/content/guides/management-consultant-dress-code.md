---
title: "Consulting: the client-facing uniform"
description: "A Toronto tailor's honest guide to the consultant's uniform — navy and charcoal, matching the client, travel-proof wool, and conservative-but-sharp fit."
tldr: "A consultant does not pick the dress code, the client does, so the safe play is a well-cut navy or charcoal suit, quiet shirt, and polished shoes in travel-proof wool. Dress one notch above the room, never below, and let the fit do the talking."
...
related: ["how-startup-founders-dress", "accountant-dress-code", "architect-creative-professional-style", "dressing-for-senior-management"]
---
...
- **High-twist worsted wool.** It springs back after a flight and a taxi and a full day of sitting. This is the single most important choice for a road warrior — see [choosing your cloth](/guides/choosing-your-cloth) for what to look for.
...
Hang the jacket the second you land, give the trousers a light steam, and a good travel wool looks fresh with almost no effort. More on keeping it sharp in [how to care for your suit](/guides/how-to-care-for-your-suit).
...
Off-the-rack rarely delivers all of that on a real body — a longer torso, an athletic build, one shoulder lower than the other. That's the work a tailor does. See [how a suit should fit](/guides/how-a-suit-should-fit) for exactly what to check on yourself in the mirror.

## The short version

Two suits — navy and charcoal — in a wool built for travel, a few quiet shirts, a couple of muted ties, dark polished shoes. Dress one notch above the client, never below. Keep the palette tight so everything packs and mixes. Conservative but sharp, and let the fit do the talking. This is the same logic behind [dressing for finance](/guides/dressing-for-finance) and [dressing for senior management](/guides/dressing-for-senior-management) — quiet authority, no flash.

If you're on the road more than you're home, we run a [traveling-tailor service](/design) across the GTA and can fit you around a client schedule. Come in for a [free, no-obligation first fitting](/book) and we'll build a small, sharp travel wardrobe that works in any client's building — or let's [design a suit](/design) from the cloth up. No pressure, and the first fitting's on us.
