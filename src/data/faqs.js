...
export const faqs = [
  ...
  { cat: 'Weddings', q: 'Do you make custom tuxedos?', a: "Yes — midnight and black tuxedos with satin peak or shawl lapels, made to your measurements at the Vaughan atelier or on a house call across the GTA. A tuxedo is the garment where fit shows most, which is exactly why it's worth having made rather than rented." },
  ...
  { cat: 'Weddings', q: 'Can you dress the groom, groomsmen and both fathers together?', a: "Yes — that's the ideal. Measuring everyone against the same notebook keeps colour, lapel and detail consistent, and I can do it at the atelier or on one house call. It's the easiest way to keep a whole wedding party coordinated." },
  ...
  // ── Trust ─────────────────────────────────────────────────────
  { cat: 'Trust', q: 'How long have you been tailoring?', a: "Over thirty years, and the last decade-plus from the studio in Vaughan. I still measure, cut and fit every garment myself — nothing is outsourced." },
